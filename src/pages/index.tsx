  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Welcome to HR Information System - Streamlining your employee data, vacation management, and payroll processes all in one place. Empowering employers for better workforce management." />
      ...
      <Image flex="1" src={'https://images.unsplash.com/photo-1573496130407-57329f01f769?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxodW1hbiUyMHJlc291cmNlc3xlbnwwfHx8fDE2OTc1MzY3NzN8MA&ixlib=rb-4.0.3&q=80&w=1080'} alt="Dinner" objectFit="cover" objectPosition="center" />
      <Box
        position="absolute"
        top="0"
      ...
      >
        <Text align='center' fontSize="sm" color="white">
          Photo by {' '}
          <Link href='https://unsplash.com/@wocintechchat?utm_source=roq-generator&utm_medium=referral' isExternal color="teal.200">{`Christina @ wocintechchat.com`}</Link> on {' '}
          <Link href="https://unsplash.com/?utm_source=roq-generator&utm_medium=referral" isExternal color="teal.200">Unsplash</Link>
        </Text>
      </Box>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Streamlining your employee data, vacation management, and payroll processes all in one place. Empowering employers for better workforce management.`}
            </Text>
            <Box
